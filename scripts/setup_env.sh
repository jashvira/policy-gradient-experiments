...
#   bash scripts/setup_env.sh --hf-token $HF_TOKEN --download-model Qwen/Qwen2.5-Coder-3B --dest /mnt/models/qwen
...
QWEN_MODEL_ID_DEFAULT="Qwen/Qwen2.5-Coder-3B"
QWEN_DEST_DEFAULT="${REPO_ROOT}/.models/Qwen2.5-Coder-3B"
